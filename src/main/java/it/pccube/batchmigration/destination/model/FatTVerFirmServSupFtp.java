...
public class FatTVerFirmServSupFtp  implements ModelEntity {
	
	public static final String TABLE_NAME = "FAT_T_VER_FIRM_SERV_SUP_FTP";
	
	public static final String INSERT_QUERY = "INSERT INTO FAT_T_VER_FIRM_SERV_SUP_FTP ( CD_CERT_SERIAL_NUMBER, CD_CERT_STATUS, CD_CERT_STATUS_CODE, CD_CRL_NUMBER, DS_CERT_STATUS_INFO, DT_CERT_END_DATE, DT_CERT_START_DATE, DT_CRL_EMISSION_DATE, ID_DIZ_TIPOLOGIA_FIRMA, ID_VERIF_FIRMA_SERVICE_SUP_FTP, ID_VERIF_FIRMA_SUPPORTO_FTP, NM_ISSUER_DN, NM_SUBJECT_DN, NM_UTENTE_INSERIMENTO, NM_UTENTE_ULTIMA_MODIFICA, NR_CERT_LEVEL, TS_INSERIMENTO, TS_ULTIMA_MODIFICA ) VALUES ( :cdCertSerialNumber, :cdCertStatus, :cdCertStatusCode, :cdCrlNumber, :dsCertStatusInfo, :dtCertEndDate, :dtCertStartDate, :dtCrlEmissionDate, :idDizTipologiaFirma, :idVerifFirmaServiceSupFtp, :idVerifFirmaSupportoFtp, :nmIssuerDn, :nmSubjectDn, :nmUtenteInserimento, :nmUtenteUltimaModifica, :nrCertLevel, :tsInserimento, :tsUltimaModifica )";
	...
	public Long getIdVerifFirmaServiceSupFtp() {
		return idVerifFirmaServiceSupFtp;
	}
	...
	public String getPKDescription() {
		return this.idVerifFirmaServiceSupFtp.toString();
	}
