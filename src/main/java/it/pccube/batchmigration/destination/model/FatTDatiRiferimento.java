...
public class FatTDatiRiferimento implements ModelEntity {
	
	public static final String TABLE_NAME = "FAT_T_DATI_RIFERIMENTO";
	
	public static final String INSERT_QUERY = "INSERT INTO FAT_T_DATI_RIFERIMENTO ( CD_CODICE_CIG, CD_CODICE_COMMESSA_CONVENZIONE, CD_CODICE_CUP, CD_DOCUMENTO, CD_NUM_ITEM, DT_DATA, FL_EPROC, ID_DATI_RIFERIMENTO, ID_DIZ_TIPO_DATI_RIFERIMENTO, ID_DIZ_TIPO_INIZIATIVA, ID_FATTURA, ID_FATTURA_COLLEGATA, ID_IDT, ID_ORDINE_ACQUISTO, ID_TRATTATIVA, NM_UTENTE_INSERIMENTO, NM_UTENTE_ULTIMA_MODIFICA, TS_INSERIMENTO, TS_ULTIMA_MODIFICA )VALUES( :cdCodiceCig, :cdCodiceCommessaConvenzione, :cdCodiceCup, :cdDocumento, :cdNumItem, :dtData, :flEproc, :idDatiRiferimento, :idDizTipoDatiRiferimento, :idDizTipoIniziativa, :idFattura, :idFatturaCollegata, :idIdt, :idOrdineAcquisto, :idTrattativa, :nmUtenteInserimento, :nmUtenteUltimaModifica, :tsInserimento, :tsUltimaModifica)";
	...
	public String getPKDescription() {
		return this.idDizTipoDatiRiferimento.toString();
	}
