...
public class FatTDatiCassaPrevidenz implements ModelEntity {
	
	public static final String TABLE_NAME = "FAT_T_DATI_CASSA_PREVIDENZ";
	
	public static final String INSERT_QUERY = "INSERT INTO FAT_T_DATI_CASSA_PREVIDENZ (CD_RIFERIMENTO_AMMINISTRAZIONE,ID_DATI_CASSA_PREVIDENZIALE,ID_DIZ_ESIGIBILITA_IVA,ID_DIZ_NATURA,ID_DIZ_RITENUTA,ID_DIZ_TIPO_CASSA,ID_FATTURA,IM_ARROTONDAMENTO,IM_IMPONIBILE_CASSA,IM_IMPORTO_CONTRIBUTO_CASSA,NM_NUMERO_SEZIONE,NM_UTENTE_INSERIMENTO,NM_UTENTE_ULTIMA_MODIFICA,PC_AL_CASSA,PC_ALIQUOTA_IVA,TS_INSERIMENTO,TS_ULTIMA_MODIFICA) VALUES (:cdRiferimentoAmministrazione, :idDatiCassaPrevidenziale, :idDizEsigibilitaIva, :idDizNatura, :idDizRitenuta, :idDizTipoCassa, :idFattura, :imArrotondamento, :imImponibileCassa, :imImportoContributoCassa, :nmNumeroSezione, :nmUtenteInserimento, :nmUtenteUltimaModifica, :pcAlCassa, :pcAliquotaIva, :tsInserimento, :tsUltimaModifica)";
	...
	public String getPKDescription() {
		return this.idDatiCassaPrevidenziale.toString();
	}
