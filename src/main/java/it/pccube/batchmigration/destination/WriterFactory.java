...
public class WriterFactory {
	...
	private <T> String getQuery(Class<T> clazz) {
		...
		case "FatTVerifFirmaAde":
			...
			break;
		case "FatTVerifFirmaEsitoFtp":
			query = FatTVerifFirmaEsitoFtp.INSERT_QUERY;
			break;
		case "FatTVerifFirmaLotto":
			query = FatTVerifFirmaLotto.INSERT_QUERY;
			break;
		case "FatTVerifFirmaNotifica":
			query = FatTVerifFirmaNotifica.INSERT_QUERY;
			break;
		case "FatTVerFirmServEsiFtp":
			query = FatTVerFirmServEsiFtp.INSERT_QUERY;
			break;
		case "FatTVerifFirmaServAde":
			query = FatTVerifFirmaServAde.INSERT_QUERY;
			break;
		case "FatTVerifFirmServNotif":
			query = FatTVerifFirmServNotif.INSERT_QUERY;
			break;
