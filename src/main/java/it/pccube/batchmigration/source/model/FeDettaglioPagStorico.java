...
public class FeDettaglioPagStorico implements ModelEntity {

	public static final String TABLE_NAME = "FE_DETTAGLIO_PAG_STORICO";

	private Long idDettaglioPagStorico;
	...
	public Long getIdDettaglioPagStorico() {
		return idDettaglioPagStorico;
	}

	public void setIdDettaglioPagStorico(Long idDettaglioPagStorico) {
		this.idDettaglioPagStorico = idDettaglioPagStorico;
	}
	...
	public String getPKDescription() {
		return this.idDettaglioPagStorico.toString();
	}
